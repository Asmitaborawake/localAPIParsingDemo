...
//        do {
//            if let file = Bundle.main.url(forResource: "tagsAPI", withExtension: "txt") {
//                let data = try Data(contentsOf: file)
//                let json = try JSONSerialization.jsonObject(with: data, options: [])
//                
//                print(json)
//                if let jsondata = json as? [String:AnyObject] ,
//                    let response  = jsondata["items"] as? [[String:AnyObject]] {
//                    for data in response {
//                    print("accepted_answer_id\(data["accepted_answer_id"] as? Int)")
//                     print("answer_count\(data["answer_count"] as? Int)")
//                        print("creation_date\(data["creation_date"] as? Int)")
//                         print("link\(data["link"] as? String)")
//                        if let owner = data["owner"] as? NSDictionary {
//                        print("accept_rate\(owner["accept_rate"] as? Int)")
//                        print("display_name\(owner["display_name"] as? String)")
//                        print("link\(owner["link"] as? String)")
//                            print("profile_image\(owner["profile_image"] as? String)")
//       
//                            
//                        }
